//  이미 공유된 자료이다. 여기서 핵심은 JS의 오브젝트 구조를 아는것이다.
//  qnaList는 q와 a라는 키를 가지고 있다. q라는 키에는 화면에 보여줄 질문을 값으로 가지고 있다.
//  a의 키는 q의 질문에 대한 대답을 값으로 가지고 있다.
//  a의 값은 질문에 대한 키와  type의 키로 나누어져 있으며 type은 최종 결과에 대한 값을 나타내기 위한 값들이 들어있다.
const qnaList = [
    {q: '1. 이성 사이에 진정한 친구는 있다, 없다?', a: [
    ...
    },
    {
        ...
        a: [
            ...
            {
                answer: 'b. "야! 너 화내지마. 너 잘못이지. 내가 뭘 잘못했는데?" 소리지르며 끝까지 불같이 화낸다.',
                type: [0, 2, 5, 10, 8]
            },
...
//  최종 결과에서 즉 type 키에 대한 값들의 결산을 통해 나타낼 값들을 가지고 있다.
//  결산의 결과는 순번을 나타낸다.
const infoList = [
    {
